...
export declare const Formatters: {
    ...
    alignCenter: import("../models/formatter.interface").Formatter;
    /** Align cell value to the right */
    alignRight: import("../models/formatter.interface").Formatter;
    /**
    ...
    bsDropdown: import("../models/formatter.interface").Formatter;
    /** Center a text value horizontally */
    center: import("../models/formatter.interface").Formatter;
     ...
     */
    complex: import("../models/formatter.interface").Formatter;
    ...
    fakeHyperlink: import("../models/formatter.interface").Formatter;
    /**
    ...
    tree: import("../models/formatter.interface").Formatter;
    /** Formatter that must be use with a Tree Data column for Exporting the data */
    treeExport: import("../models/formatter.interface").Formatter;
