...
export declare class SharedService {
    ...
    onTreeItemToggled: Subject<TreeToggleStateChange>;
    onTreeFullToggleStart: Subject<{
        collapsing: boolean;
    }>;
    onTreeFullToggleEnd: Subject<Omit<TreeToggleStateChange, "fromItemId">>;
