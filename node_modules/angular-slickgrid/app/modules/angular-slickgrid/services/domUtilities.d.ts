...
import { Column, SearchTerm, SlickGrid } from '../models/index';
/**
 ...
 */
export declare function buildSelectEditorOrFilterDomElement(type: 'editor' | 'filter', collection: any[], columnDef: Column, grid: SlickGrid, isMultiSelect?: boolean, translateService?: TranslateService, searchTerms?: SearchTerm[]): {
