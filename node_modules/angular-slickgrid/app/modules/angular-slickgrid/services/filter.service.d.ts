...
import { Column, ColumnFilters, CurrentFilter, EmitterType, Filter, FilterCallbackArg, FilterConditionOption, GridOption, OperatorString, OperatorType, SearchColumnFilter, SearchTerm, SlickEvent, SlickEventHandler } from './../models/index';
...
export declare class FilterService {
    ...
    protected _firstColumnIdRendered: string;
     ...
     * @param triggerBackendQuery defaults to True, which will query the backend.
     */
    updateSingleFilter(filter: CurrentFilter, emitChangedEvent?: boolean, triggerBackendQuery?: boolean): void;
    /** Add all created filters (from their template) to the header row section area */
    protected addFilterTemplateToHeaderRow(_event: Event | undefined, args: {
        column: Column;
        grid: any;
        node: HTMLElement;
     ...
     */
    protected callbackSearchEvent(event: any | undefined, args: FilterCallbackArg): void;
    /**
    ...
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<FilterService>;
}
