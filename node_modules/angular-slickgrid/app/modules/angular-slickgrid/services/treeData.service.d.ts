import { Column, ColumnSort, GridOption, SlickDataView, SlickEventHandler, ToggleStateChangeType, ToggleStateChangeTypeString, TreeDataOption, TreeToggledItem, TreeToggleStateChange } from '../models/index';
...
export declare class TreeDataService {
    ...
    private sortService;
    private _isLastFullToggleCollapsed;
    private _lastToggleStateChange;
    private _currentToggledItems;
    private _grid;
    private _eventHandler;
    constructor(sharedService: SharedService, sortService: SortService);
     ...
     */
    applyToggledItemStateChanges(treeToggledItems: TreeToggledItem[], previousFullToggleType?: Exclude<ToggleStateChangeType, 'toggle'> | Exclude<ToggleStateChangeTypeString, 'toggle'>, shouldPreProcessFullToggle?: boolean, shouldTriggerEvent?: boolean): void;
    /**
    ...
    sortHierarchicalDataset<T>(hierarchicalDataset: T[], inputColumnSorts?: ColumnSort | ColumnSort[]): {
        hierarchical: T[];
        flat: { [P in Exclude<keyof T, number | "toString" | "valueOf" | "toLocaleString" | "charAt" | "charCodeAt" | "concat" | "indexOf" | "lastIndexOf" | "localeCompare" | "match" | "replace" | "search" | "slice" | "split" | "substring" | "toLowerCase" | "toLocaleLowerCase" | "toUpperCase" | "toLocaleUpperCase" | "trim" | "length" | "substr" | "codePointAt" | "includes" | "endsWith" | "normalize" | "repeat" | "startsWith" | "anchor" | "big" | "blink" | "bold" | "fixed" | "fontcolor" | "fontsize" | "italics" | "link" | "small" | "strike" | "sub" | "sup" | "padStart" | "padEnd" | "trimLeft" | "trimRight" | "trimStart" | "trimEnd">]: T[P]; }[];
    };
    /**
    ...
    private handleOnCellClick;
    private updateToggledItem;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TreeDataService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<TreeDataService>;
}
