...
export declare class ExtensionService {
    private readonly autoTooltipExtension;
    private readonly cellExternalCopyExtension;
    private readonly cellMenuExtension;
    private readonly checkboxSelectorExtension;
    private readonly columnPickerExtension;
    private readonly contextMenuExtension;
    private readonly draggableGroupingExtension;
    private readonly gridMenuExtension;
    private readonly groupItemMetaExtension;
    private readonly headerButtonExtension;
    private readonly headerMenuExtension;
    private readonly rowDetailViewExtension;
    private readonly rowMoveManagerExtension;
    private readonly rowSelectionExtension;
     ...
     * @param extensionName
     */
    private recreateExternalAddon;
    /** Translate an array of items from an input key and assign translated value to the output key */
    private translateItems;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ExtensionService, [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, { optional: true; }]>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<ExtensionService>;
}
