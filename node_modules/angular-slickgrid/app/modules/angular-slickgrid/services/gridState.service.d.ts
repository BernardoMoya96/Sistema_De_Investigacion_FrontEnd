...
import { Column, CurrentColumn, CurrentFilter, CurrentPagination, CurrentRowSelection, CurrentSorter, GridState, GridStateChange, TreeToggleStateChange } from './../models/index';
...
export declare class GridStateService {
    ...
    private readonly resizerService;
    ...
    constructor(extensionService: ExtensionService, filterService: FilterService, resizerService: ResizerService, sharedService: SharedService, sortService: SortService, treeDataService: TreeDataService);
    ...
    /**
       ...
       */
    private addColumnDynamicWhenFeatureEnabled;
    /**
     ...
     * @param grid - SlickGrid object
     */
    private bindSlickGridOnSetOptionsEventToGridStateChange;
    /**
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<GridStateService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<GridStateService>;
}
