...
export declare class AngularSlickgridComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    private readonly gridEventService;
    private readonly gridService;
    private readonly gridStateService;
    private readonly groupingAndColspanService;
    ...
    private _isLeftFooterOriginallyEmpty;
    private _isLeftFooterDisplayingSelectionRowCount;
    private _isPaginationInitialized;
    private _isLocalGrid;
    private _paginationOptions;
    private _selectedRowCount;
     ...
     */
    private registerOnSelectedRowsChangedWhenEnabled;
    /**
